	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				.info(new Info()
						...
						.description("Projeto Blog Pessoal - Cezar Palomino")
						.version("v0.0.1")
					.license(new License()
						.name("Cezar Palomino")
						.url("https://github.com/CezarPalomino/"))
					.contact(new Contact()
						.name("Blog Pessoal")
						.url("https://github.com/CezarPalomino/BlogPessoal")
						.email("cezarprazec@gmail.com")))
